//------------------------------------------------------------------------------
// <copyright file="LoadingGraphPanelController.cs" company="FurtherSystem Co.,Ltd.">
...
// <summary>
// Loading Graph Panel Controller
// </summary>
//------------------------------------------------------------------------------
...
{
    public class LoadingGraphPanelController : MonoBehaviour
    {
        [SerializeField]
        Image bar1;
        [SerializeField]
